...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2026 a las 03:31:55
...
(84, 2, 'ciudad', 'Zona 10, Guatemala City', NULL, NULL, '2026-04-28 16:00:01'),
(85, 2, 'ciudad', 'Antigua Guatemala', NULL, NULL, '2026-04-28 16:00:01'),
(86, 2, 'ciudad', 'Quetzaltenango', NULL, NULL, '2026-04-28 16:00:01'),
(87, 2, 'ciudad', 'Escuintla', NULL, NULL, '2026-04-28 16:00:01'),
(88, 2, 'ciudad', 'Flores, Petén', NULL, NULL, '2026-04-28 16:00:01'),
(89, 2, 'ciudad', 'Paseo de la Reforma 250, CDMX', NULL, NULL, '2026-04-28 16:00:01'),
(90, 2, 'ciudad', 'Polanco, Ciudad de Mexico', NULL, NULL, '2026-04-28 16:00:01'),
(91, 2, 'ciudad', 'Centro Historico CDMX', NULL, NULL, '2026-04-28 16:00:01'),
(92, 2, 'ciudad', 'Ocean Drive, Miami Beach', NULL, NULL, '2026-04-28 16:00:01'),
(93, 2, 'ciudad', 'Brickell Avenue, Miami', NULL, NULL, '2026-04-28 16:00:01'),
(94, 2, 'ciudad', 'Downtown Miami', NULL, NULL, '2026-04-28 16:00:01'),
(95, 2, 'ciudad', 'Av. Larco, Miraflores, Lima', NULL, NULL, '2026-04-28 16:00:01'),
(96, 2, 'ciudad', 'San Isidro, Lima', NULL, NULL, '2026-04-28 16:00:01'),
(97, 2, 'ciudad', 'Barranco, Lima', NULL, NULL, '2026-04-28 16:00:01'),
(98, 2, 'ciudad', 'Zona Rosa, Bogota', NULL, NULL, '2026-04-28 16:00:01'),
(99, 2, 'ciudad', 'Usaquen, Bogota', NULL, NULL, '2026-04-28 16:00:01'),
(100, 2, 'ciudad', 'Centro Bogota', NULL, NULL, '2026-04-28 16:00:01');
...
(124, 2, 'vuelo', 'web', 'MEX', 'GUA', NULL, '2027-12-10', NULL, 1, '2026-04-28 03:54:06'),
(125, 2, 'vuelo', 'web', 'MEX', 'GUA', NULL, '2027-12-10', NULL, 1, '2026-04-28 03:54:25'),
(126, 2, 'vuelo', 'web', 'MEX', 'GUA', NULL, '2027-12-10', NULL, 2, '2026-04-28 03:55:31'),
(127, 2, 'hotel', 'web', NULL, NULL, 'Guatemala', '2027-12-10', '2027-12-15', 1, '2026-04-28 03:57:20'),
(128, 2, 'hotel', 'web', NULL, NULL, 'Guatemala', '2027-12-10', '2027-12-15', 1, '2026-04-28 03:58:37'),
(129, 2, 'hotel', 'web', NULL, NULL, 'Guatemala', '2027-12-10', '2027-12-15', 1, '2026-04-28 03:59:23');
...
(1, 'Aerolíneas Halcón', 'aerolinea', 'http://localhost:8081/aerolineas', 'admin@halcon.com', '123', 10.00, NULL, 'Guatemala', 'activo', '2026-04-06 19:07:35'),
(2, 'BedlyHoteles', 'hotel', 'http://localhost:5044', 'admin@bedly.com', '82A1629B-F583-430C-AC52-661ABC860E4A', 10.00, NULL, 'Guatemala', 'activo', '2026-04-08 21:59:58');
...
(9, 'Armando', 'Velazquez', 'noobmen2019@gmail.com', 'User1234!', '2005-10-11', 'Guatemala', 'Guatemalteco', 'A09182736', 'usuario', 'activo', '2026-04-28 07:37:30');
...
--
ALTER TABLE `cache_destinos`
  MODIFY `id_cache` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
...
--
ALTER TABLE `historial_busqueda`
  MODIFY `id_busqueda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
ALTER TABLE `reservacion`
  MODIFY `id_reservacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
